        ...
        <div class="tabs-block__right">
          <div class="tabs-block__content" v-if="activeTab === 'sites'">
            <ServiceCard
                ...
                :modal-images="['/src/image/examp1.jpg', '/src/image/examp2.jpg']"
            />
            ...
            <ServiceCard
                ...
                :modal-images="['/src/image/examp3.jpg', '/src/image/examp4.jpg']"
            />
            ...
            <ServiceCard
                ...
                :modal-images="['/src/image/examp5.jpg']"
            />
            ...
            <ServiceCard
                ...
                :modal-images="['/src/image/examp6.jpg']"
            />
            ...
            <ServiceCard
                ...
                :modal-images="['/src/image/examp7.jpg']"
            />
            ...
            <ServiceCard
                ...
                :modal-images="['/src/image/examp8.jpg']"
            />
            ...
            <ServiceCard
                ...
                :modal-images="['/src/image/examp9.jpg']"
            />
            ...
            <ServiceCard
                ...
                :modal-images="['/src/image/examp10.jpg']"
            />
            ...
            <ServiceCard
                ...
                :modal-images="['/src/image/examp11.jpg']"
            />
            ...
            <ServiceCard
                ...
                и кодированию.</p>"
                :modal-images="['/src/image/examp12.jpg', '/src/image/examp13.jpg']"
            />
          </div>
          ...
          <div class="tabs-block__content" v-else-if="activeTab === 'shops'">
            <ServiceCard
                ...
                :modal-images="['/src/image/examp14.jpg']"
            />
...
Заказы, Клиенты, Опции, Настройки, Установка и Обновление, Инфо.</p>"
                :modal-images="['/src/image/examp15.jpg']"
            />
...
При создании интернет-магазина будет полностью учтена стилистика Вашего сайта.</p>"
                :modal-images="['/src/image/examp16.jpg']"
            />
...
JoomShopping имеет множество возможностей, среди которых такие, как:
            ...
            Клиенты, Опции, Настройки, Установка и Обновление, Инфо.</p>"
                :modal-images="['/src/image/examp17.jpg']"
            />
...
JoomShopping имеет множество возможностей, среди которых такие, как:
            ...
            Настройки, Установка и Обновление, Инфо.</p>"
                :modal-images="['/src/image/examp18.jpg']"
            />
            ...
            <ServiceCard
                ...
                :modal-images="['/src/image/examp19.jpg']"
            />
...
Многообразие способов оплаты; Мгновенное подтверждение и зачисление осуществляемого платежа</p>"
                :modal-images="['/src/image/examp20.jpg']"
            />
...
обратной связи или звоните по телефону: +7 (902) 687-71-41.</p>"
                :modal-images="['/src/image/examp21.jpg']"
            />
            ...
            <ServiceCard
                ...
                :modal-images="['/src/image/examp22.jpg']"
            />
...
Чтобы заказать услугу, заполните форму обратной связи или звоните по телефону: +7 (902) 687-71-41.</p>"
                :modal-images="['/src/image/examp23.jpg']"
            />
            ...
            <ServiceCard
                ...
                :modal-images="['/src/image/examp24.jpg']"
            />
          </div>
...
Компания «Вебразработка» предлагает свои услуги для разработки оригинального, современного лого.</p>"
                :modal-images="['/src/image/examp25.jpg', '/src/image/examp26.jpg']"
            />
            ...
            <ServiceCard
                ...
                его развитию.</p>"
                :modal-images="['/src/image/examp27.jpg']"
            />
...
приложение для смартфона ( андроид и IOS ) с уведомлениями; приложение для ПК с уведомлениями; возможность просматривать кто сейчас на сайте и напрямую писать им.</p>"
                :modal-images="['/src/image/examp28.jpg']"
            />
...
Перенос калькулятора с одного сайта на другой; Калькулятор-конфигуратор металлочерепицы и домов.</p>"
                :modal-images="['/src/image/examp29.jpg']"
            />
...
Имеются демонстрационные варианты готовых калькуляторов.</p>"
                :modal-images="['/src/image/examp30.jpg']"
            />
...
распечатанные презентации можно раскладывать под стекло автомобиля, в почтовые ящики и в бизнес-центры.</p>"
                :modal-images="['/src/image/examp31.jpg']"
            />
...
Пример 2: http://www.yantarniy-nn.ru/index.php?option=com_content&view=article&id=243&Itemid=285</p>"
                :modal-images="['/src/image/examp32.jpg']"
            />
            ...
            <ServiceCard
                ...
                :modal-images="['/src/image/examp33.jpg']"
            />
...
! Внимание - компания Вебразработка не выполняет ручных переводов. Тексты с переводом предоставляет заказчик.</p>"
                :modal-images="['/src/image/examp34.jpg']"
            />
            ...
            <ServiceCard
                ...
                :modal-images="['/src/image/examp36.jpg']"
            />
            ...
            <ServiceCard
                ...
                :modal-images="['/src/image/examp37.jpg']"
            />
...
Разработка фирменного стиля от «Вебразработка» – это путь к повышению узнаваемости бренда.</p>"
                :modal-images="['/src/image/examp38.jpg']"
            />
...
Вам привлечь новых клиентов для Вашего бизнеса.</p>"
                :modal-images="['/src/image/examp39.jpg', '/src/image/examp40.jpg']"
            />
            ...
            <ServiceCard
                ...
                :modal-images="['/src/image/examp41.jpg']"
            />
            </div>
