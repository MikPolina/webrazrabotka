<template>
  ...
  >
    <div class="form-big__overlay">
      ...
      <!-- Выпадающий список -->
      <div class="form-big__select-wrapper">
        <select v-model="selectedService" class="form-big__select">
          <option value="" disabled selected>Выберите услугу</option>
          <option v-for="option in options" :key="option" :value="option">
            {{ option }}
          </option>
        </select>
        <svg class="form-big__select-arrow" width="33" height="19" viewBox="0 0 33 19" fill="none" xmlns="http://www.w3.org/2000/svg">
...
defineProps({
  ...
  options: {
    type: Array,
    default: () => ['Разработка сайта', 'Продвижение', 'Реклама', 'Дизайн']
  }
})
...
.form-big__select::placeholder {
  color: white;
}

.form-big__select-arrow {
  position: absolute;
  right: 15px;
  top: 50%;
